  ...
  const handleNotifications = () => {
    alert(
      [
        'Care India Updates',
        '',
        '1. Stay hydrated during the current heatwave advisory.',
        '2. Wear a mask in crowded places due to flu risk.',
        '3. Review your next appointment details in Care Directory.',
      ].join('\n'),
    );
  };
  ...
  return (
    <header className="h-16 bg-white border-b border-gray-100 px-6 flex items-center justify-between sticky top-0 z-10">
      ...
      <div className="flex items-center gap-4">
        <button type="button" onClick={handleNotifications} className="w-10 h-10 flex items-center justify-center rounded-full hover:bg-gray-50 text-gray-400 relative">
